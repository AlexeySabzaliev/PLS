...
BILLING_LINE_SHORT_NAMES: dict[str, str] = {
    ...
    "extra_vehicle_docs": "Дополнительные комплекты ТС",
    "repack_units": "Переупаковка (единиц приборов)",
    "custom_pallet": "Паллетирование (доп. обработка), шт.",
    "overtime_m3": "Сверхурочная обработка (вход и выход), м³",
    "inventory_hours": "Инвентаризация (чел./час)",
    "elco_drain_hours": "Слив технологической жидкости с котлов ELCO",
    "valve_gluing": "Подклейка клапанов гофрокоробов",
    "vietnam_stickering": "Стикерование (Вьетнам)",
    "flue_stickering": "Стикерование дымоходов",
    "elco_passports": "Паспорта ELCO (на ТС)",
    "extra_vehicle_docs_rf": "Дополнительные комплекты РФ (на ТС)",
    "extra_vehicle_docs_rb": "Дополнительные комплекты РБ (на ТС)",
}
...
UNIT_BY_CODE = {
    ...
    "extra_vehicle_docs_rf": "vehicle",
    "extra_vehicle_docs_rb": "vehicle",
    "elco_passports": "vehicle",
    "repack_units": "pcs",
    "valve_gluing": "pcs",
    "vietnam_stickering": "pcs",
    "flue_stickering": "pcs",
    "custom_pallet": "pcs",
...
FORMULA_BY_CODE = {
    ...
    "extra_vehicle_docs_rf": "rate_times_qty",
    "extra_vehicle_docs_rb": "rate_times_qty",
    "elco_passports": "rate_times_qty",
    "repack_units": "rate_times_qty",
    "valve_gluing": "rate_times_qty",
    "vietnam_stickering": "rate_times_qty",
    "flue_stickering": "rate_times_qty",
    "custom_pallet": "rate_times_qty",
...
_NAME_RULES: list[tuple[tuple[str, ...], str]] = [
    ...
    (("стикер", "вьетнам"), "vietnam_stickering"),
    (("стикер", "дымоход"), "flue_stickering"),
    (("дополнительн", "комплект"), "extra_vehicle_docs"),
    (("комплект", "рф"), "extra_vehicle_docs_rf"),
    (("комплект", "рб"), "extra_vehicle_docs_rb"),
    (("документ", "рф"), "extra_vehicle_docs_rf"),
    (("документ", "рб"), "extra_vehicle_docs_rb"),
